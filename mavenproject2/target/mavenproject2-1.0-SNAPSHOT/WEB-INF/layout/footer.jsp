<%-- 
    Document   : footer
    Created on : Aug 20, 2021, 3:00:28 PM
    Author     : LocNe
--%>
...
<footer class="footer spad">
  ...
  Copyright ©<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">OU</a>
