...
<!--                <li><a data-toggle="tab" href="#messages">Menu 1</a></li>
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="home">
                    <hr>
                    <form:form class="form" method="post" action="${save}" modelAttribute="user">
                        ...
                        <div class="form-group">                   
                            <div class="col-xs-6">
                                ...
                                <form:input type="password" class="form-control" path="confirmPassword" id="password2" placeholder="Confirm Password" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
